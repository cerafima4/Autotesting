module.exports = {
	'перейти на сайт google.com': function (browser) {
		browser
			...
			.waitForElementVisible('#tsf > div:nth-child(2) > div.A8SBwf > div.RNNXgb > div > div.a4bIc > input', 5000);
	},
	...
	'проверяем наличие количества результатов поиска': function (browser) {
		browser
			.assert
